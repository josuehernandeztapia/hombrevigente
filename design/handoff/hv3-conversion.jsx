    ...
    <Pad3>
      ...
      <GlassCard className="hv-rise" pad={18} style={{ display:'flex', alignItems:'center', gap:18, marginBottom:14 }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:7 }}>
          <span style={{ fontFamily:MONO, fontSize:8.5, letterSpacing:'.08em', textTransform:'uppercase', color:t.low, border:`1px solid ${t.line}`, borderRadius:5, padding:'1px 5px', alignSelf:'flex-start', marginBottom:2 }}>ejemplo ilustrativo</span>
          {SCAN.signals.map(s => (
